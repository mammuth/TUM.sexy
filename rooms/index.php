...
<html>
    ...
    <body>
        <?php
        $site = file_get_contents('https://campus.tum.de/tumonline/wbrisweb.status_mobile_mi');
        $site = strtr($site, $replacements); // apply replacements
        // replace refresh icon...yep - the original is an absolutely crazy one, only replaceably by regex.
        $site = preg_replace('/src=\"data:image\/png;base64,.*\"/s', 'src=refresh.png', $site); 
        echo $site;
        ?>
