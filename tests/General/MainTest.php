...
class MainTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testRouteResolving() {
        ...
        $this->assertStringContainsString('https://www.moodle.tum.de/course/view.php?id=58083', $router->getTargetOfSub('mgbs.tum.sexy'));

        // Normal redirect still works, even if it has moodle type assigned
        $this->assertStringContainsString('https://db.in.tum.de/teaching/ws2021/grundlagen/?lang=de', $router->getTargetOfSub('db.tum.sexy'));
    }
